...
const translations: Record<Language, TranslationValue> = {
  kk: {
    ...
    voice: {
      ...
      askCommand: 'Алан деп айтыңыз. Сосын: модульге көш. Артқа — кері оралу.',
      openingModule: 'Бірінші модульді ашамын.',
      onHomePage: 'Бұл басты бет',
      speaking: 'Сөйлеп тұрмын',
      listening: 'Тыңдап тұрмын',
      idle: 'Дайын',
      waiting: 'Алан деп айтыңыз',
      heard: 'Естідім',
      didNotUnderstand: 'Түсінбедім. Алан деп айтыңыз. Модульге көш. Немесе артқа.',
      repeat: 'Қайта тыңдау',
      listen: 'Тыңдау',
  ...
  ru: {
    ...
    voice: {
      ...
      askCommand: 'Скажите «Алан». Затем: модульге көш. «Артқа» — назад.',
      openingModule: 'Открываю первый модуль.',
      onHomePage: 'Это главная страница',
      speaking: 'Говорю',
      listening: 'Слушаю',
      idle: 'Готов',
      waiting: 'Скажите «Алан»',
      heard: 'Услышал',
      didNotUnderstand: 'Не понял. Скажите «Алан». Модульге көш. Или «артқа».',
      repeat: 'Повторить',
      listen: 'Слушать',
      thinking: 'Распознаю',

...
const translations: Record<Language, TranslationValue> = {
  kk: {
    ...
    voice: {
      ...
      skipVideoHint:
        'Астыңғы ақ жерді түртіңіз. «Стоп» немесе «жалғастыру». «Алға» / «артқа» — 10 секунд. «Тапсырмаларға өт» — жаттығулар.',
  ...
  ru: {
    ...
    voice: {
      ...
      skipVideoHint:
        'Нажмите белую полосу внизу. «Стоп» или «продолжить». «Вперёд» / «назад» — на 10 секунд. «К заданиям» — упражнения.',
      didNotUnderstandOnLessonVideo:
  ...
  en: {
    ...
    voice: {
      ...
      skipVideoHint:
        'Tap the talk bar. Say stop or continue. Say forward or back to jump 10 seconds. Say skip to exercises to start the tasks.',
      didNotUnderstandOnLessonVideo:
